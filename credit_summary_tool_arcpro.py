...
grid = arcpy.cartography.GridIndexFeatures(gridoutput, mu, "INTERSECTFEATURE", "NO_USEPAGEUNIT", None, "", "", "", 4, 4, 1, "NO_LABELFROMORIGIN") ###10,000 x 10,000
...
arcpy.CopyFeatures_management("grid", "index_template") ##replace index layer with new grid. pointing layer to new 
